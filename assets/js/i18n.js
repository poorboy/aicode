...
(function (global) {
  ...
  var MESSAGES = {
    zh: {
      ...
      'feat.sub': '从任务编排、引擎实例调度，到实时输出、失败自愈、知识检索与容器构建，\n        你需要的环节都已经在同一个程序里跑通。',
...
curl -s -H <span class="s">"x-tk: $TK"</span> <span class="s">"$BASE/api/tk/linenv/artifacts?path=build"</span>`,
    ...
    en: {
      ...
      'feat.c8.t1': 'Projects, knowledge collections and instances isolated per user',
